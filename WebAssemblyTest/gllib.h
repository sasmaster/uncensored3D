...
inline void create_texture()
{

}

inline GLuint compile_shader_program(const char* vert_str, const char* frag_str)
{
...
inline void create_shader_program(StandardShaderProgram* prog, const char* vertStr, const char* fragStr)
{
...
inline void create_vbo(GLuint *vbo, GLuint *ibo, const void* vertices, const size_t vertex_size,
...
inline void create_plane_mesh(Mesh* mesh)
{
